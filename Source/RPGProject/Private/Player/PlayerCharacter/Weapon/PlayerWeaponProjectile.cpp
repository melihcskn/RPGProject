...
#include "Player/PlayerCharacter/Weapon/PlayerWeaponProjectile.h"

#include "Kismet/GameplayStatics.h"
#include "PhysicalMaterials/PhysicalMaterial.h"

// Sets default values
APlayerWeaponProjectile::APlayerWeaponProjectile()
{
	...
	CollisionComponent->OnComponentHit.AddDynamic(this,&APlayerWeaponProjectile::OnHit);
}

// Called when the game starts or when spawned
void APlayerWeaponProjectile::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void APlayerWeaponProjectile::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void APlayerWeaponProjectile::FireInDirection(const FVector& ShootDirection)
{
	ProjectileMovementComp->Velocity = ShootDirection*ProjectileMovementComp->InitialSpeed;
}

void APlayerWeaponProjectile::OnHit(UPrimitiveComponent* HitComponent,
	AActor* OtherActor,
